...
<div class="row">
  ...
  <div class="card">
  <h5 class="card-header"><i class="fas fa-luggage-cart"></i> Form Produk</h5>
  <div class="card-body">
  ...
  <form action="<?= base_url() ?>produk/simpan" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Produk" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="file" class="btn btn-info ml-3" id="img" name="img" placeholder="Masukan Gambar" required>
    </div>
